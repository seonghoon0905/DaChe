document.addEventListener('DOMContentLoaded', () => {
    ...
    function convertToBanmal(text) {
        ...
        const rules2 = [
            ...
            { pattern: /깁니다(\.|\?|!| |$)/g, replace: '긴다$1' },
            { pattern: /지닙니다(\.|\?|!| |$)/g, replace: '지닌다$1' },
            { pattern: /거칩니다(\.|\?|!| |$)/g, replace: '거친다$1' },
            { pattern: /이릅니다(\.|\?|!| |$)/g, replace: '이른다$1' },
            { pattern: /따릅니다(\.|\?|!| |$)/g, replace: '따른다$1' },
            { pattern: /다룹니다(\.|\?|!| |$)/g, replace: '다룬다$1' },
            { pattern: /이룹니다(\.|\?|!| |$)/g, replace: '이룬다$1' },
            { pattern: /치릅니다(\.|\?|!| |$)/g, replace: '치른다$1' },
            { pattern: /띕니다(\.|\?|!| |$)/g, replace: '띈다$1' },
            { pattern: /미칩니다(\.|\?|!| |$)/g, replace: '미친다$1' },
            { pattern: /미룹니다(\.|\?|!| |$)/g, replace: '미룬다$1' },
            { pattern: /앞섭니다(\.|\?|!| |$)/g, replace: '앞선다$1' },
            { pattern: /쓰입니다(\.|\?|!| |$)/g, replace: '쓰인다$1' },
            { pattern: /보입니다(\.|\?|!| |$)/g, replace: '보인다$1' },
            { pattern: /나뉨니다(\.|\?|!| |$)/g, replace: '나뉜다$1' },
            { pattern: /열립니다(\.|\?|!| |$)/g, replace: '열린다$1' },
            { pattern: /끌립니다(\.|\?|!| |$)/g, replace: '끌린다$1' },
            { pattern: /풀립니다(\.|\?|!| |$)/g, replace: '풀린다$1' },
            { pattern: /갈립니다(\.|\?|!| |$)/g, replace: '갈린다$1' },
            { pattern: /날립니다(\.|\?|!| |$)/g, replace: '날린다$1' },
            { pattern: /올립니다(\.|\?|!| |$)/g, replace: '올린다$1' },
            { pattern: /흘립니다(\.|\?|!| |$)/g, replace: '흘린다$1' },
            { pattern: /살립니다(\.|\?|!| |$)/g, replace: '살린다$1' },
            { pattern: /달립니다(\.|\?|!| |$)/g, replace: '달린다$1' },
            { pattern: /밀립니다(\.|\?|!| |$)/g, replace: '밀린다$1' },
            { pattern: /물립니다(\.|\?|!| |$)/g, replace: '물린다$1' },
            { pattern: /돌립니다(\.|\?|!| |$)/g, replace: '돌린다$1' },
            { pattern: /늘립니다(\.|\?|!| |$)/g, replace: '늘린다$1' },
            { pattern: /불립니다(\.|\?|!| |$)/g, replace: '불린다$1' },
            { pattern: /줄입니다(\.|\?|!| |$)/g, replace: '줄인다$1' },
            { pattern: /높입니다(\.|\?|!| |$)/g, replace: '높인다$1' },
            { pattern: /밝힙니다(\.|\?|!| |$)/g, replace: '밝힌다$1' },
            { pattern: /낮춥니다(\.|\?|!| |$)/g, replace: '낮춘다$1' },
            { pattern: /맞춥니다(\.|\?|!| |$)/g, replace: '맞춘다$1' },
            { pattern: /갖춥니다(\.|\?|!| |$)/g, replace: '갖춘다$1' },
            { pattern: /멈춥니다(\.|\?|!| |$)/g, replace: '멈춘다$1' },
            { pattern: /바꿉니다(\.|\?|!| |$)/g, replace: '바꾼다$1' },
            { pattern: /거듭납니다(\.|\?|!| |$)/g, replace: '거듭난다$1' },
            { pattern: /드러납니다(\.|\?|!| |$)/g, replace: '드러난다$1' },
            { pattern: /어긋납니다(\.|\?|!| |$)/g, replace: '어긋난다$1' },
            { pattern: /벗어납니다(\.|\?|!| |$)/g, replace: '벗어난다$1' },
            { pattern: /일어납니다(\.|\?|!| |$)/g, replace: '일어난다$1' },
            { pattern: /나타냅니다(\.|\?|!| |$)/g, replace: '나타낸다$1' },
